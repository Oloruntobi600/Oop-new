...
public class Main {
    public static void main(String[] args) {
        ...
        Teacher teacher1 = new Teacher(1, "Bimbo", 20, "mokola", 0);
        Teacher teacher2 = new Teacher(2, "Segun", 20, "mokola", 0);
        Teacher teacher3 = new Teacher(3, "Sayo", 20, "mokola", 0);
...
//        System.out.println("My name is :" + student1);
        ...
        StudentCourses studentCourse1 = new StudentCourses(1, 001, 100, 0, 'F');
        StudentCourses studentCourse2 = new StudentCourses(1, 001, 101, 0, 'F' );
        StudentCourses studentCourse3 = new StudentCourses(1, 001, 102, 0, 'F' );

        StudentCourses studentCourse4 = new StudentCourses(2,002, 100, 0, 'F' );
        StudentCourses studentCourse5 = new StudentCourses(2,002, 101, 0, 'F' );
        StudentCourses studentCourse6 = new StudentCourses(2,002, 102, 0, 'F' );

        StudentCourses studentCourse7 = new StudentCourses(3, 003, 100, 0, 'F');
        StudentCourses studentCourse8 = new StudentCourses(3, 003, 101, 0, 'F');
        StudentCourses studentCourse9 = new StudentCourses(3, 003, 102, 0, 'F');
